...
App.UIC.Editable = React.createClass({
  /**
  * Prop definition
  */
  propTypes: {
  ...
  */
  ...
  render: function() {
    if(this.state.editable){
      return(
        <input type="text" className="area_input" ref="new_name" defaultValue={this.state.name} onBlur={this.blured} />
      );
    }
    else{
      return(
        <span onDoubleClick={this.double_clicked} >{this.state.name}</span>
      );
    }
  }
});