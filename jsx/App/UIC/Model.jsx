...
App.UIC.Model = React.createClass({
  /**
  * defined prop types
  */
  propTypes: {
  ...
  */
  render: function() {
    ...
    return(
        <div className="model" id={this.props.id} draggable="true" onDragStart={this.drag_started} style={this.props.styles}>
            <header>
                <h3>
                  <strong>
                    <App.UIC.Editable name={this.props.name} callback={this.props.renamed}/>
                  </strong>
                  <a onClick={this.remove_model}><span className="glyphicon glyphicon-trash"></span></a>
                  </h3>
            </header>
            <table>
              <tbody>
            ...
            <div style={add_anything_visibility}>
              <div style={property_form_visibility}>
                <App.Form.Property ref="new_property" model_property_types={this.props.model_property_types}/>
                <button className="btn" onClick={this.add_new_property}>Add new property</button>
              </div>
              <div style={endpoint_form_visibility}>
                <App.Form.Endpoint ref="new_endpoint" />
                <button className="btn" onClick={this.add_new_endpoint}>Add new endpoint</button>
              </div>
            </div> 
            <div className="model-icons-wrapper">
              <div className="model-icons">
                <a onClick={this.show_data_structure}><span className={data_icon_class}></span></a>
                <a onClick={this.show_rest_routes}><span className={rest_icon_class}></span></a>
              </div>
              <div className="model-options">
                <a onClick={this.set_the_new_property_form_visibility}><span className={add_property_icon} title="add new property"></span></a>
              </div>
