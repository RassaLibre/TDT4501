...
App.UIC.Wizard.Content = React.createClass({
  /**
    ...
    return(
      <div style={this.styles}>
        ...
        <form className="form" callback={this.submited}>
          <div style={style.sec_1}>
            <label>Name:</label>
            <input type="text" ref="name" className="fancy_input" required/>
            <p><i>continue to properties...</i></p>
          </div>
          <div style={style.sec_2}>
            <h3>Properties <a onClick={this.add_property}><span className="glyphicon glyphicon-plus"></span></a></h3>
            {prop_forms}
            <p><i>continue to endpoints...</i></p>
          </div>
          <div style={style.sec_3}>
            <h3>Endpoints <a onClick={this.add_endpoint}><span className="glyphicon glyphicon-plus"></span></a></h3>
            {end_forms}
